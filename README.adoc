...
| image:https://img.shields.io/maven-central/v/br.org.soujava/pom-editor-maven-plugin?style=flat-square[Maven Central, link=https://central.sonatype.com/search?smo=true&q=br.org.soujava&sort=published, window=_blank, target=_blank]
|===
== Introduction
