...
*Plugin Documentation:* image:https://github.com/soujava/pom-editor-maven-plugin/actions/workflows/github-pages.yml/badge.svg[Documentation,link=https://soujava.github.io/pom-editor-maven-plugin/plugin-info.html, window=_blank, target=_blank]
